...
class InjectConfig:
    ...
    """Dir of per-object PLYs. Auto:
    ``outputs/<scene>/object-accum/latest/`` from ``lad object-accum``.
    Pass an explicit path to use a pre-existing tree (e.g.
    ``preview/recon_3I_full/``)."""
